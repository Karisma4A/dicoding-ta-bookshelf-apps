(() => {
  ...
  function n(t) {
    ...
    query = n.value, query ? c(e.filter((
      function (e) {
  ...
  function o(t) {
    const n = Number(t.target.id), o = e.findIndex((
      function (e) {
        return e.id === n
      }));
  ...
  function a() {
    ...
    const o = document.querySelector("#inputBook"),
      d = document.querySelector("#searchBook"); o.addEventListener("submit", t),
